...
# DBTITLE 1, Truncate mrr_30day_customers_data table
# MAGIC %scala
# MAGIC import com.microsoft.azure.sqldb.spark.config.Config
# MAGIC import com.microsoft.azure.sqldb.spark.query._
# MAGIC import sqlContext.implicits._
# MAGIC val query = """    TRUNCATE TABLE dbo.mrr_30day_customers_data""".stripMargin
# MAGIC  
...
# MAGIC   "url"            -> "eventsdw.database.windows.net",
# MAGIC   "databaseName"   -> "bi-db",
# MAGIC   "dbTable"        -> "mrr_30day_customers_data",
# MAGIC   "user"           -> "bi_user",
# MAGIC   "password"       -> "tLymmiFPnLYp5yOUOlPz",
...
# MAGIC import com.microsoft.azure.sqldb.spark.query._
# MAGIC import sqlContext.implicits._
# MAGIC val query = """ EXEC dbo.azure_merge_mrr_30day_customers_data_to_Customers_Models_Data""".stripMargin
# MAGIC  
# MAGIC val config = Config(Map(
# MAGIC   "url"          -> "eventsdw.database.windows.net",
# MAGIC   "databaseName" -> "bi-db",
...
# MAGIC as
# MAGIC select Accountnumber , now() as Sync_Date ,230 as Model_ID,Model_Result 
