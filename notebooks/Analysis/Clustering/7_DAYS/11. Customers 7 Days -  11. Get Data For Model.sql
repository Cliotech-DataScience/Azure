...
--and Event_Date_day>=date_add(now(), -60)
 )
 select AccountNumber
      ,folder
      ,Supplier_Group
...
from dwhdb.events e
join population_data p on  (p.AccountNumber = e.AccountNumber) and  e.Event_Date_day<= date_add(p.FirstDepositday,6) 
where Source='fxnet'
 and  Event_Name='deal' 
and Event_Date_day>='2019-01-01';
...
select count(*) from 7_days_trading_activity
...
from 7_days_trading_activity a
...
select  
       ...
       c.trading_days,
       d.FirstDepositDate,
       d.deposit_amount_6_days_after_deposit,
       d.deposit_events_6_Days_after_Deposit,
...
-- COMMAND ----------
 ...
 -- drop table dwhdb.Clustering_Model_2_Days_Customers_Data
--  create table dwhdb.Clustering_Model_2_Days_Customers_Data
--  USING DELTA
...
--create table dwhdb.Clustering_Model_7_Days_Customers_Data
--using delta
--select * from Customers_data_for_all_insert

-- COMMAND ----------

-- DBTITLE 1,Add new Customers Data to Clustering Model 7 Days Customers_Data table
MERGE INTO dwhdb.Clustering_Model_7_Days_Customers_Data e
...
OPTIMIZE dwhdb.Clustering_Model_7_Days_Customers_Data;
set spark.databricks.delta.retentionDurationCheck.enabled = false;
VACUUM   dwhdb.Clustering_Model_7_Days_Customers_Data RETAIN 0 HOURS;
...
-- DBTITLE 1,Accounts to update Data Mining Date
